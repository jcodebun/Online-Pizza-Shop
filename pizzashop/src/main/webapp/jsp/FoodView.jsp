<%@page import="in.co.pizza.shop.controller.FoodCtl"%>
<%@page import="in.co.pizza.shop.util.HTMLUtility"%>
		...
		<div class="row block-9">
			...
			<div class="col-md-6 ftco-animate">
				<form action="<%=OFDView.FOOD_CTL%>" method="post" enctype="multipart/form-data"
					...
					<jsp:useBean id="bean"
						class="in.co.pizza.shop.bean.FoodBean"
					...
					<div class="form-group">
								<input type="text" name="foodName" class="form-control"
									...
									placeholder="Enter Pizza Name"> <font color="red">
