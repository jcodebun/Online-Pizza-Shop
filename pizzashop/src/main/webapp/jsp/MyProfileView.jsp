<%@page import="in.co.pizza.shop.controller.MyProfileCtl"%>
	...
	<div class="container mt-5">
		...
		<div class="row block-9">
			...
			<div class="col-md-6 ftco-animate">
				<form action="<%=OFDView.MY_PROFILE_CTL%>" method="post" class="contact-form">
				
				<jsp:useBean id="bean" class="in.co.pizza.shop.bean.UserBean"
			...
			<input type="hidden" name="modifiedDatetime"
				value="<%=DataUtility.getTimestamp(bean.getModifiedDatetime())%>">
					...
					<div class="form-group">
						<input type="text" name="login" readonly="readonly" class="form-control" value="<%=DataUtility.getStringData(bean.getLogin())%>"
					...
					<div class="form-group">
						<input type="submit" name="operation"
							class="btn btn-primary py-3 px-5" value="<%=MyProfileCtl.OP_SAVE%>">
