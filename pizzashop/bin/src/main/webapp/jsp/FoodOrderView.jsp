<%@page import="in.co.pizza.shop.controller.FoodOrderCtl"%>
<%@page import="in.co.pizza.shop.util.DataUtility"%>
<%@page import="in.co.pizza.shop.util.ServletUtility"%>
<%@page import="in.co.pizza.shop.model.FoodOrderModel"%>
<%@page import="in.co.pizza.shop.bean.RestaurantBean"%>
<%@page import="in.co.pizza.shop.model.RestaurantModel"%>
<%@page import="in.co.pizza.shop.bean.FoodBean"%>
<%@page import="in.co.pizza.shop.bean.FoodOrderBean"%>
<%@page import="in.co.pizza.shop.model.FoodModel"%>
		...
		<div class="row block-9">
			...
			<div class="col-md-6 ftco-animate">
				<form action="<%=OFDView.FOOD_ORDER_CTL%>" method="post" 
					...
					<jsp:useBean id="bean"
						class="in.co.pizza.shop.bean.FoodOrderBean"
