<%@page import="in.co.pizza.shop.controller.RestaurantUserCtl"%>
	...
	<div class="container mt-5">
		...
		<div class="row block-9">
			...
			<div class="col-md-6 ftco-animate">
				<form action="<%=OFDView.RESTAURANT_OWNER_CTL%>" method="post" enctype="multipart/form-data" class="contact-form">
				...
				value="<%=DataUtility.getTimestamp(bean.getModifiedDatetime())%>">
					...
					<div class="form-group">
						<input type="submit" name="operation"
							class="btn btn-primary py-3 px-5" value="<%=RestaurantUserCtl.OP_SAVE%>">
							<input type="submit" name="operation"
							class="btn btn-primary py-3 px-5" value="<%=RestaurantUserCtl.OP_RESET%>">
					</div>
				</form>
			</div>
		</div>
